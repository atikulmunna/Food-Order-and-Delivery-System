...
int main()
{
    ...
    while (1)
    {
        ...
        printf("1.SIGNUP\n");
        printf("2.LOGIN\n");
        printf("3.DElIVERY PERSONS' DATABASE\n");
        printf("4.EXIT\n\n");


        printf("Type '1' to be registered as a new user;\n");
        printf("Type '2' if you already have an account;\n");
        printf("Type '3' if you want to see the delivery man database;\n");
...
void registration()
{
    ...
    printf("\n[Plz Give the 10 Digit contact number]\n");
    ...
    if (flag == 1)
    {
        ...
        if (count >= 2 && strlen(temp_email) >= 5)
        {
            if (!strcmp(temp_password1,temp_password2))
            {
                ...
                {
                    printf("\nYour Password length must be between 8 and 32 digits.\n\n");
                    return 0;
                }
            }
            else
...
void cart()
{
    ...
    if (ch == 1)
    {
        ...
        printf("Would you like to rate us in a scale of 1 to 5?\nTap 1 for YES & 0 for NO (We won't mind at all!)\n=>");
        scanf("%d",&C);
        if(C==1){
            printf("\nRating: ");
            scanf("%f",&compliment);
            if((compliment>0)&&(compliment<3))
            {
                printf("\nWe are sorry to make you sad. Please drop a mail to our customer care why you are dissatisfied");
                printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
                main();
            }
            else if((compliment>3)&&(compliment<4))
            {
               printf("\nThanks for your honest review. Kindly let us know our drawbacks.");
               printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
               main();
            }
            ...
            {
               printf("\nWe are truly gratified. Thank you.");
               printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
               main();
            }
...
void insert()
{
    ...
    printf("Name of the delivery person       : ");
