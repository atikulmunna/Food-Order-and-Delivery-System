...
int main()
{
    ...
    while (1)
    {
        ...
        printf("1.SIGNUP\n");
        printf("2.LOGIN\n");
        printf("3.DElIVERY MAN DATABASE\n");
        printf("4.EXIT\n\n");
...
void food_order(int food)
{
    ...
    {
        printf("How many of the mouth-watering %s do you want?\t=>", foodmenuvar[restaurant_id].Choice3);
        scanf("%d", &n);
    ...
    {
        printf("How many of the tempting %s do you want?\t=>", foodmenuvar[restaurant_id].Choice4);
        scanf("%d", &n);
    ...
    {
        printf("How many of the appetizing %s do you want?\t=>", foodmenuvar[restaurant_id].Choice5);
        scanf("%d", &n);
